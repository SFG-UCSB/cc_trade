...
# Export results
saveRDS(gdata, file.path(datadir, "gaines_global_level_results_approach1_imperfect.Rds"))
...
# Export results
saveRDS(cdata, file.path(datadir, "gaines_country_level_results_approach1_imperfect.Rds"))
