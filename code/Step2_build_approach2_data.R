...
gdata <- data %>% 
  ...
  summarize(msy_tot1=sum(msy_eez[year==2012], na.rm=T),
            msy_tot2=sum(msy_eez[year==year_end], na.rm=T),
            c_tot=sum(harvest_eez, na.rm=T),
            p_tot=sum(profit_eez, na.rm=T),
            bbmsy_avg2=mean(bbmsy[year==year_end], na.rm=T),
...
# Export results
filename <- paste0("gaines_global_level_results_approach2_", year_end, ".Rds")
...
# Export data
filename <- paste0("gaines_country_level_results_approach2_", year_end, ".Rds")
...
# Export results
filename <- paste0("gaines_territory_level_results_approach2_", year_end, ".Rds")
...
# Export data
filename <- paste0("gaines_country_stock_level_results_approach2_", year_end, ".Rds")
...
# Export results
filename <- paste0("gaines_territory_stock_level_results_approach2_", year_end, ".Rds")
