...
# Load data
final <- readRDS(file.path(datadir, "gaines_data_for_eez_analysis.Rds"))
...
# Export results
saveRDS(gdata, file.path(datadir, "gaines_global_level_results_approach1.Rds"))
...
# Export results
saveRDS(cdata, file.path(datadir, "gaines_country_level_results_approach1.Rds"))
...
# Export results
saveRDS(tdata, file.path(datadir, "gaines_territory_level_results_approach1.Rds"))
...
# Export results
saveRDS(csdata, file.path(datadir, "gaines_country_stock_level_results_approach1.Rds"))
...
# Export results
saveRDS(tsdata, file.path(datadir, "gaines_territory_stock_level_results_approach1.Rds"))
