...
# Tracey uses these initial values: horizontal_bar_fig.R
# For testing Tracey's code: 
# globalresults <- readRDS("data/gaines/raw/global_cc_manuscript_results_1nation_20171005.rds")
# Tracey's total: RCP60 Range Shift Only climate_change  2012 746826707. 53403939. 52468524670.
tot2012 <- proj_tot %>%
...
# Save figure
ggsave(p, filename=file.path(plotdir, "Fig4_global_barplot.png"), dpi = 300, width = 11, height = 8.5, units = "in")
